...
const Home: React.FC<HomeProps> = ({ onSelectProduct }) => {
  ...
  return (
    <main className="flex-1 w-full max-w-[1280px] mx-auto px-4 md:px-10 lg:px-40 py-8 animate-in fade-in duration-500">
      ...
      <div className="relative h-[520px] w-full rounded-[40px] overflow-hidden mb-12 group shadow-2xl">
        ...
        <div className="absolute inset-0 bg-black/30 flex flex-col justify-center px-16">
          <div className="max-w-2xl">
            ...
            <h1 className="text-6xl md:text-7xl font-black text-white mb-8 leading-[1.1] font-display tracking-tight">
              Nông sản mộc mạc,<br/>
              <span className="text-[#4fa94d]">Giá trị thật.</span>
            </h1>
