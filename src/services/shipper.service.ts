...
class ShipperService {
  ...
  async register(shipperData: ShipperRegisterRequest, documents?: {
    ...
    try {
      ...
      if (documents?.vehicleRegistration) formData.append('vehicleRegistration', documents.vehicleRegistration);
      if (documents?.portrait) formData.append('portrait', documents.portrait);
